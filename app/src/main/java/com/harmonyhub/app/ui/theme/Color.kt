...
// Dark Theme Colors
val md_theme_dark_primary = Color(0xFFA0CAFF) // Lighter blue for dark theme
...
val schedule_parent1 = Color(0xFF4EA5DC) // Light blue for parent 1
val schedule_parent2 = Color(0xFF8A9EE4) // Purple-blue for parent 2
val neutral_background = Color(0xFFF6F8FA) // Light background for cards